...
author: "Priscilla Obando Rodríguez"
date: "2020-10-07"
output:
  html_document:
    theme: readable    
...
algo[1:10, c("name_long", "lifeExp"), drop=TRUE]


ggplot(algo, aes(x=name_long, y=lifeExp)) +
  ggtitle("Esperanza de vida de Asia, mayores a 80 años") +
  xlab("País") + 
...
plot(oceania["lifeExp"], main="Esperanza de vida en Oceanía")
...
plot(ca["lifeExp"], main="Esperanza de vida en Centroamerica")
...
plot(amsur2["area_km2"], main="Países de América del Sur, área mayor o igual a 2.5 millones km2")
...
plot(amsur4["pop"], main="Países de América del Sur, población mayor o igual a 40 millones de personas")
